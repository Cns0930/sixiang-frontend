...
Handlebars.registerHelper("guquan_zhuanrang_gaizhang", function (arr, options) {
    ...
    for(var j = 0;j < arr.length;j=j+2) {
        ...
        if(j == arr.length-1){
            // 需要直接返回单个
            str = str+'<p><span style="color:black;font-family:仿宋;font-size:12.0pt;">'+'&emsp;&emsp;'+v1.othername+'（签字、盖章）</span></p><p>&emsp;</p><p>&emsp;</p>';
            break;
        }
        str = str+'<p><span style="color:black;font-family:仿宋;font-size:12.0pt;">'+'&emsp;&emsp;'+v1.othername+'（签字、盖章） &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;'+v2.othername+'（签字、盖章）</span></p><p>&emsp;</p><p>&emsp;</p>';
    }
    return str;
});
...
Handlebars.registerHelper("zhiwu_chanshengfangshi_for_short", function(arg1){
    if(arg1.includes("选举")){
        return "选举";
    }else if(arg1.includes("聘任")){
        return "聘任";
    }else if(arg1.includes("任命")){
        return "任命";
    }else{
        return "选举";
    }
