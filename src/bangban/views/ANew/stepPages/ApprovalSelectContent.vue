                ...
                <div class="select-form">
                    <el-form hide-required-asterisk ref="approvalSelectForm" label-width="200px" label-position="left"
                        ...
                        <el-form-item label="请选择事项" prop="approval">
                            ...
                            <el-checkbox v-if="qingxingCheckBox" style="margin-left: 20px;" v-model="qingxingCheckBox.value" @change="handleExtraChange">{{qingxingCheckBox.label}}</el-checkbox>
                        </el-form-item>
                        <el-divider />
...
export default {
    ...
    computed: {
        ...
        qingxingCheckBox(){
            if(this.config.find(v => v != 'qingxing_checkbox')){
                return this.itemState[this.config.find(v => v != 'qingxing_checkbox')]
            }
            return null;
        }
    ...
    methods: {
        ...
        handleExtraChange(val) {
                ...
                this.itemState['fact1'].attributes.isHidden = !val;
            if(!val){
                _.pull(this.itemState['fact1'].value,this.itemState['fact1'].attributes.options.map(v=>v.needHidden))
            }
