...
// 查询测试用例表-分页
export const listTestcase = params => { return axios.get(`/superform/testcase/listTestcase`, {params}).then(res=>res.data); };
...
// 修改测试用例表
export const updateTestcase = params => { return axios.put(`/superform/testcase/updateTestcase`, {params}).then(res=>res.data); };
