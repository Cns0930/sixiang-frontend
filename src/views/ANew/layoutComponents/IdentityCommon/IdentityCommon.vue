...
import { getDWObject } from '@/Dynamsoft'
import idPositive from './id-positive.png'
import idNagetive from './id-nagetive.png'
import Processing from './Processing'
import { GetCertBaseDataApi, IdCrodTakePhotoApi, TestIdCard,idCardCopyRecogApi} from '@/api/ANew'
...
export default {
    ...
    methods: {
        ...
        setIdCards() {
            // console.log("进入setIdcard",this.recogType,)
        ...
        checkErrorStringWithErrorCode(errorCode, errorString, responseString) {
            ...
            if (errorCode === -2003) {
                ...
                console.log("数量问题",this.imgList.length,this.DWObject.HowManyImagesInBuffer)
