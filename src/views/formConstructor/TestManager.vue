    ...
    <div class="test-manager">
        <div class="table">
            ...
            <div class="tableWrap">
                <el-table :data="tableData" border style="width: 100%">
                    ...
                    <el-table-column label="序号" type="index" width="100" align="center" :index="indexMethod">
                    </el-table-column>
                    <el-table-column prop="unittestName" label="单元测试名称" align="center">
                    </el-table-column>
        ...
        <div class="tablePagination">
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                :current-page.sync="currentPageTable" :page-size="pageSizeTable"
                layout="total, sizes, prev, pager, next" :total="totalTable"></el-pagination>
        </div>
        <el-dialog title="单元测试修改" :visible.sync="editDialogVisible" width="50%" :close-on-click-modal="false">
            <div class="attribute">
                <div>
                    <span class="attribute-key">单元测试名称</span>
                    <el-input v-model="unitTestObj.unittestName" placeholder="请输入内容" class="attribute-value-in">
                    </el-input>
                </div>

                <div>
                    <span class="attribute-key">单元测试代码</span>
                    <CodeEditor v-model="unitTestObj.unittestCodeinfo" ref="codeEditorEdit"></CodeEditor>
                </div>
        ...
        <el-dialog title="单元测试添加" :visible.sync="addDialogVisible" :close-on-click-modal="false" width="50%">
            <div class="attribute">
                <span class="attribute-key">单元测试名称</span>
                <el-input v-model="addValue" placeholder="请输入内容"></el-input>
                <span class="attribute-key">单元测试代码</span>
                <CodeEditor v-model="addCode" ref="codeEditorAdd"></CodeEditor>
            </div>
...
export default {
    ...
    methods: {
        // 自增id
        indexMethod(index) {
            return (this.currentPageTable - 1) * this.pageSizeTable + (index + 1);
        },
        // 获取情形选择框
        ...
        //打开编辑框
        async open(obj) {
            this.$refs.codeEditorEdit.open = false;
