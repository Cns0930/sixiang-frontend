<template>
    <vueCropper height="200px" ref="cropper" :img="imgUrl" :outputSize="option.size" :outputType="option.outputType"
        :info="true" :guides="true" :high='option.high' :fixed="true" :full="option.full" :canMove="option.canMove"
        ...
        :fixedNumber="option.fixedNumber" :maxImgSize="option.maxImgSize" @realTime="realTime"
        :infoTrue="option.infoTrue" @imgLoad="imgLoad">
    </vueCropper>
</template>
<script>
// 引入组件
